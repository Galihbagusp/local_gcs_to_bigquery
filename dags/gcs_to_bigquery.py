...
PROJECT_ID = os.environ.get("GCP_PROJECT_ID",'rising-hallway-379116')
BUCKET = os.environ.get("GCP_GCS_BUCKET",'de_bucket-1')
...
def format_to_parquet(src_file):
    ...
    table = table.rename_columns([x.replace('.','_') for x in table.column_names])
...
with DAG(
    ...
    format_to_parquet_task >> local_to_gcs_task >> bigquery_external_table_task >> bq_create_partitioned_table_job
